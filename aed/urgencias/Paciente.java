...
public class Paciente implements Comparable<Paciente> {
  ...
  public int compareTo(Paciente paciente) {
	    if (getPrioridad() == paciente.getPrioridad()) {
	        if (getTiempoAdmisionEnPrioridad() == paciente.getTiempoAdmisionEnPrioridad()) {
	            return getTiempoAdmision() - paciente.getTiempoAdmision();
	        }
	        return getTiempoAdmisionEnPrioridad() - paciente.getTiempoAdmisionEnPrioridad();
	    }
	    return getPrioridad() - paciente.getPrioridad();
	}
  ...
  public boolean equals(Object obj) {
	    ...
	    if (obj instanceof Paciente) {
	      ...
	      return getDNI().equals(otherPaciente.getDNI());
	    } else return false;
	  }

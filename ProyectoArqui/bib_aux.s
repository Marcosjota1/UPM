...
.CONTESC: EOR.L D0,D0           * A0 contiene la direcci�n del puntero de extracci�n
        ...
        MOVE.B  D1,(A2)+                * Inserta el         CMP.L   A2,A4           * Si son iguales  ha llegado al final del buffer
        BNE     .ACPUNE
...
INIT:
     ...
     MOVE.B          #%00000101,CRA      * Transmision y recepcion activado>
     RTS

...
public class entregaFinalV9 {
    ...
    static class TS {
        ...
        TS(String lexema, String tipo, int numParams, List<String> paramTypes, String returnType, int despl, int pos, String param) {
            this.lexema = lexema;
            this.tipo = tipo;
...
if (reservadas.containsKey(word)) {
    ...
    if (!tsOptionalLocal.isPresent()) {
        ...
        TS nuevoSimbolo = new TS(word, "", 0, tiposParametros, "", 0, pos, ""); // Usar posición adecuada
        if (capturaParametros) {
        ...
        public static class Parser {
            ...
            public String parse(BufferedWriter parseWriter, List<Token> tokens, List<List<TS>> tablaGlobal2 ) throws IOException {
                ...
                private void F() {
                    ...
                    DESPL = 0;
                    TSA = 0;
                    addToFunctio(posTabla, "function", retornoFuncion, numParametros, tiposParametros);                   
                ...
                public void addToFunctio(String posicionTabla, String tipo, String retornoFuncion, int numParametros, List<String> tiposParametros) {
                    try {
                ...
                public void addReturnFunction(String retorno){

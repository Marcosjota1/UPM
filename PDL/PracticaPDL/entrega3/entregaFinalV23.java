                 ...
                 * private void inicializar(String pos) {
                    ...
                    if (tipo == null || tipo.isEmpty()) {
                        ...
                        if (TSA == 0) {
                            ...
                            try {
                                // Obtener la tabla local
                                List<TS> tablaLocal = TablaGlobal.get(TSA);
                                if (tablaLocal == null) {
                                    System.err.println("Error: Tabla local no encontrada.");
                                    return;
                                }
                
                                // Buscar el símbolo en la tabla local
                                ...
                                if (simboloLocal == null) {
                                    System.err.println("Error: Símbolo no encontrado en la tabla local.");
                                    return;
                                }
                                ...
                                simboloLocal.pos = TablaGlobal.get(0).size(); // Nueva posición en tabla global
                                ...
                                System.out.println("El identificador en la posición " + pos + " se movió de la tabla local a la global y se asignó el tipo 'entero'.");
                            } catch (NumberFormatException e) {
                                System.err.println("Error al procesar la posición de la tabla: " + pos);
                            }
                        }
                    }
                }

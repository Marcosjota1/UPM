...
Condición del if ha de ser lógica  (CHECK) → heredar resultado, ya que menor devuelve entero y no logico
...
LLamada a función, comprobar coinciden parámetros

// Falta tabla de simbolos incluye todo(Excepto modo de pasar parametros por valor/referencia) ??
//Falta desplazamiento casos variables void  ->  no va(Las no inicializadas peta el procesador)
 */


public class entregaFinalV14 {

...
public class entregaFinalV26 {
    ...
    public static List<Token> generateTokens(String data, List<List<TS>> tablaGlobal,int[] numTabla, BufferedWriter errorWriter) {
        ...
        public static class Parser {
            ...
            private Stack<List<String>> contextoArgumentos = new Stack<>(); //Pila para manejas argumentos de las funciones y no sobreescribirse al realizar llamado en el llamado
            private int TSA;
            private int TSL;
            private int linea;
        ...
        this.parameterTypes = parameterTypes;
            ...
            public String parse(BufferedWriter parseWriter, List<Token> tokens, List<List<TS>> tablaGlobal2 ) throws IOException {
                ...
                private void L() {
                    ...
                    // Crea un nuevo contexto para esta llamada y lo añade al fondo de la pila
                    List<String> argumentos = new ArrayList<>();
                    contextoArgumentos.add(contextoArgumentos.size(), argumentos); // Añade el contexto al fondo
                    //contextoArgumentos.add(0, argumentos); // Añade el contexto al fondo
                    ...
                    if (token.equals("id") || token.equals("entero") || token.equals("cadena") || token.equals("parAbrir")) {
                        ...
                        System.err.println("Argumentos: " + contextoArgumentos);
                        ...
                        contextoArgumentos.remove(0); // Elimina el contexto actual
                        return;
                    }
                
                    // Verifica que el número de argumentos coincida con la firma
                    if (contextoArgumentos.get(0).size() != signature.parameterTypes.size()) {
                        System.out.println("Argumentos: " + contextoArgumentos.get(0) + " Size: " + contextoArgumentos.get(0).size() + " Signature: " + signature.parameterTypes.size());
                    ...
                    contextoArgumentos.remove(0); // Elimina el contexto actual al finalizar
                }
                ...
                private void Q(List<String> argumentos) {
                    ...
                    if (token.equals("coma")) {
                        ...
                        System.err.println("Argumentos: " + contextoArgumentos);
                        // Agrega el tipo del argumento actual a la lista

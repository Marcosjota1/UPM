...
public class entregaFinalV8 {
    ...
    static class TS {
        ...
        TS(String lexema, String tipo, int numParams, String paramTypes, String returnType, int despl, int pos, String param) {
            this.lexema = lexema;
            this.tipo = tipo;
...
if (reservadas.containsKey(word)) {
    ...
    if (!tsOptionalLocal.isPresent()) {
        ...
        TS nuevoSimbolo = new TS(word, "", 0, "", "", 0, pos, ""); // Usar posición adecuada
        if (capturaParametros) {

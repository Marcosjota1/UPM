...
/////////////////////////////////////////////////////////////////////////////////////
/// ////USAR PARA SINTACTICO Y LEXICO///////////////////////////////////////////////


public class entregaFinalV20 {
    ...
    static class TS {
        ...
        static void errorLexico(String tipo, String mensaje, int linea, BufferedWriter errorWriter) {
            ...
            /*try {
                ...
                */
                System.err.println("Syntax Error at line: " +  linea + " -> " +  errorMsg );
                System.exit(1);
        }
...
if (reservadas.containsKey(word)) {
    ...
    public static void main(String[] args) {
        ...
        File inputFile = new File("C:\\Users\\marco\\OneDrive\\Documentos\\UPM\\PDL/DracoSem2.txt");

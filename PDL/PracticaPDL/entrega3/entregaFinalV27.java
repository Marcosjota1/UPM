...
private static class FunctionSignature {
        ...
        this.parameterTypes = parameterTypes;
            ...
            public String parse(BufferedWriter parseWriter, List<Token> tokens, List<List<TS>> tablaGlobal2 ) throws IOException {
                ...
                private void L() {
                    ...
                    // Lista para almacenar los tipos de los argumentos
                    ...
                    if (token.equals("id") || token.equals("entero") || token.equals("cadena") || token.equals("parAbrir")) {
                        ...
                        argumentos.add(tipoPrimerArgumento);
                        System.err.println("Argumentos: " + argumentos); // Agrega el tipo del primer argumento a la lista
    ...
    public static void main(String[] args) {
        ...
        File inputFile = new File("C:\\Users\\marco\\OneDrive\\Documentos\\UPM\\PDL/DracoSem4.txt");

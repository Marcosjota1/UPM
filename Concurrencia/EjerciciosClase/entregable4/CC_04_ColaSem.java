package EjerciciosClase.entregable4;
...
// Y solo tendremos _1_ productor y _1_ consumidor.
...
public class CC_04_ColaSem {
	...
	public static Semaphore sEnCola = new Semaphore(TAM); 
	public static Semaphore sDesEnCola = new Semaphore(0); 
	...
	public void run () {
		...
		//Comprobamos que hay sitio
		sEnCola.await();  //Resta 1 al valor
		boolean colaLlena;
		do {
		...
		cont++;
		//Actualizas los elementos
		sDesEnCola.signal(); //Suma 1 para perimitir al consumidor ejecutar el await
	    }
	} // run
    }
	...
	public void run () {
		...
		// y lo imprimimos
		//Compruebas si se puede extraer
		sDesEnCola.await();
		boolean colaVacia;
		do {
		...
		//Actualizas el numero de elementos
		sEnCola.signal(); 
	    }
	} // run
    }
